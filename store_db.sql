...
(1, 'suppliers/create/', 'Ø¥Ù†Ø´Ø§Ø¡ Ù…ÙˆØ±Ø¯ Ø¬Ø¯ÙŠØ¯ '),
(2, 'suppliers/edit/', 'ØªØ¹Ø¯ÙŠÙ„ Ù…ÙˆØ±Ø¯ Ø¬Ø¯ÙŠØ¯'),
(3, 'suppliers/delete/', 'Ø­Ø°Ù Ù…ÙˆØ±Ø¯ '),
(4, 'suppliers/create/', 'Ø¥Ù†Ø´Ø§Ø¡ Ø¹Ù…ÙŠÙ„ Ø¬Ø¯ÙŠØ¯'),
(5, 'suppliers/edit/', 'ØªØ¹Ø¯ÙŠÙ„ Ø¹Ù…ÙŠÙ„ '),
(7, 'clients/delete/', 'Ø­Ø°Ù Ø¹Ù…ÙŠÙ„');
...
--
ALTER TABLE `app_users_groups`
  MODIFY `GroupId` tinyint(1) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `app_users_privileges`
  MODIFY `PrivilegeId` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `app_notification`
  ADD CONSTRAINT `app_notification_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `app_users` (`UserId`);
