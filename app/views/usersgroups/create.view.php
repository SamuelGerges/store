<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n100">
            <label><?= $text_label_group_name ?></label>
        ...
        <div class="input_wrapper_other">
            ...
            <?php if($privileges !== false) : foreach ($privileges as $privilege) : ?>
                <label class="checkbox block">
                    <input type="checkbox" name="privileges[]" id="privileges" value="<?= $privilege->getPrivilegeId() ?>>">
                    <div class="checkbox_button"></div>
                    <span><?= $privilege->getPrivilegeTitle() ?></span>
                </label>
